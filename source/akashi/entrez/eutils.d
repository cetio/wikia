...
static class Entrez
{
    ...
    private enum entrez = "https://eutils.ncbi.nlm.nih.gov/entrez/eutils/";

    // Rate limiting: minimum 333ms between requests (3 requests/second)
    private static const Duration minRequestInterval = msecs(333);
    private static SysTime lastRequestTime;
    ...
    static auto efetch(string DB, string RETMODE = "json")(
        string id,
